...
namespace WebAppUpnQ8Api.Repository
{
    ...
    {
        Task<Result<PagedResult<PlanDetailsModel>>> AllPlans(PlanQueryParameters parameters);
        ...
        Task<Result<PagedResult<ContentModel>>> AllContents(ContentQueryParameters parameters);
